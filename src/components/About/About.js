    ...
    const developerDetails=[
        {
            ...
            expertise: 
                ['JavaScript', 'ES6', 'ReactJs', 'Bootstrap5', 'React Bootstrap', 'HTML5',
                    'CSS3'],
           familiar: ['NodeJs', 'ExpressJs', 'MongoDB', 'Firebase', 'Tailwind'],
           Tools: ['Git', 'VSCod', 'Netlify', 'Heroku', 'Chrome Dev Tool'],
           resume: 'https://drive.google.com/file/d/1C0e3zDmnhyNpamUijjdgTgobeNpkqECS/view',
        ...
        },
        {
            ...
            Cell: '01911-870358',
            expertise: 
                ['HTML5', 'CSS3', 'JavaScript', 'Bootstrap', 'React Bootstrap', 'Tailwind CSS',

                    'Daisy UI', 'React', 'React Router'],
           familiar: ['JWT Token', 'NextJS', 'TypeScript'],
           Tools: ['VS Code', 'Github', , 'Figma', 'Imgbb', 'Photopea', 'dev tools', 'Firebase','React Firebase hooks'],
           resume: 'https://drive.google.com/file/d/1brcpLP8GRfJeG_7_djB3mHiGyBJ2biDu/view',
           education: 'B.Sc. in Computer Science & Engineering .( Prime University )',
        ...
        },
        {
            ...
            expertise: 
                ['HTML5' , 'CSS3', 'Bootstrap' , 'JavaScript' , 'React' , 'Tailwind' , 'React Router' , 'Firebase'],
           familiar: ['TypeScript' ,' React Native','Next Js'],
           Tools: ['VS code' , 'Github' , 'Netlify' , 'Heroku' , 'Firebase'],
           resume: 'https://drive.google.com/file/d/1AVhEON4sZzX5oolg1_bFzqEQ80Ew5S8D/view',
           education: 'Bachelor of Science in Applied Mathematics from (Rajshahi University )',  
           portfolio: 'https://my-portfolio-52c27.web.app/',
