...
const Details = () => {
  ...
  const likedUser = likes?.filter(
    (li) => li.id === id && li.email === user?.email
  );
            ...
            <div className="py-5 text-white">
              <div className="md:flex justify-between items-center">
                <div>
                      ...
                      return (
                        <label key={i}>
                          ...
                          <FaStar
                            className="ml-2"
                            color={
                              ratingValue <= (hover || rating || displayStar)
                                ? "#ff9501"
                                : "#222"
                            }
                            size={20}
                  ...
                  <span className="pl-8 text-[#a5a5a5] block mt-2">
                ...
                <div className="grid grid-cols-3 mr-6 md:ml-0 ml-5  md:mt-0 mt-5">
                  <div className="flex items-center ">
                    <button
                      ...
                      className={
                        likedUser?.length >= 1
                          ? "btn btn-circle like-btn liked-btn"
                          : "btn btn-circle like-btn"
                      }
                      title="Like here"
                    >
                      <BiLike />
                    ...
                    <div
                      className={likedUser?.length >= 1 ? "text-[#ff9501]" : ""}
                    >
                      Like {totalLike?.length}
                    </div>
                  </div>
            ...
            <div className="mt-5 mb-20">
              ...
              <Slider {...settings}>
                {videos.map((video) => (
                  <div key={video._id}>
                    <div
                      className="zoom-div-I pb-2 pl-0 pt-6 pr-3 video-div"
                      key={video._id}
                    >
          ...
          <div className="modal">
            <div className="modal-box bg-black relative">
              ...
              <span className="text-white items-center justify-center flex mb-4">
                Share your favorite video on social media{" "}
                <BsFillEmojiSmileFill className="ml-1" />
              </span>
