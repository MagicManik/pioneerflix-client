...
//       });
//   };
//   // md:px-14 px-3 pt-16 bg-primary text-secondary
//   // justify-center flex
//   // navigate('/solvePay')
//   // <Link to="/solvePay" style={{ backgroundImage: `url(${imgLink})`, width: "95%", height: "80vh", backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}>
//   //   <div>
//   //     <Link to='/solvePay' className="flex w-full h-[100vh] mt-56 align-middle" ><AiFillYoutube className="text-5xl text-red-500 duration-300 hover:text-red-700 mx-auto" /></Link>
//   //   </div>
//   // </Link>
//   // <Payments></Payments>
...
// >>>>>>> 6064714d5bd1bdc7aa8ca4a53d8c1e0cbd1e863f
//               </div>
