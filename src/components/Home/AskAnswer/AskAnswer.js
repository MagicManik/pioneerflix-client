...
const AskAnswer = () => {
    return (
        <div className='bg-primary w-full'>
            ...
            <div className=' px-48'>
                <div tabindex="0" class="collapse collapse-arrow border border-primary bg-secondary">
            ...
            <div className=' px-48'>
                <div tabindex="0" class="collapse collapse-arrow border border-primary bg-secondary">
                    ...
                    <div class="collapse-content text-xl">
                        <p className='pb-2'>Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from USD 3.99 to USD 11.99 a month. No extra costs, no contracts.</p>
                    </div>
                </div>
            </div>
            <div className=' px-48'>
            ...
            <div className=' px-48'>
                <div tabindex="0" class="collapse collapse-arrow border border-primary bg-secondary">
                    ...
                    <div class="collapse-content text-xl">
                        <p className='pb-2'>Pioneerflix has an extensive library of feature films, documentaries, TV shows, anime, award-winning Netflix originals, and more. Watch as much as you want, anytime you want.
                        </p> 
                    </div>
                </div>
            </div>
            <div className=' px-48'>
                <div tabindex="0" class="collapse collapse-arrow border border-primary bg-secondary">
                    ...
                    <div class="collapse-content text-xl">
                        <p className='pb-2'>The Netflix Kids experience is included in your membership to give parents control while kids enjoy family-friendly TV shows and movies in their own space.
                        </p>
