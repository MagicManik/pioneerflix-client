          ...
          <ul className="menu p-4 overflow-y-auto w-60 text-base-content">
            ...
            <li>
              <Link
                ...
                className={`uppercase font-bold text-secondary ${
                  pathname.includes("/dashboard/uploadVideo") && "bg-[#1f67f7]"
                }`}
              >
                {t("Upload video")}
              </Link>
            ...
            <li>
              <Link
                to="myVideos"
                className={`uppercase font-bold text-secondary ${
                  pathname.includes("/dashboard/myVideos") && "bg-[#1f67f7]"
                }`}
              >
               {t("My Videos")}
              </Link>
            ...
            {admin && (
              <li>
                <Link
                  to="makeAdmin"
                  className={`uppercase font-bold text-secondary ${
                    pathname.includes("/dashboard/makeAdmin") && "bg-[#1f67f7]"
                  }`}
                >
                  {t("Make Admin")}
                </Link>
            ...
            {admin && (
              <li>
                <Link
                  to="manageVideos"
                  className={`uppercase font-bold text-secondary ${
                    pathname.includes("/dashboard/manageVideos") &&
                    "bg-[#1f67f7]"
                  }`}
                >
                  {t("Manage Videos")}
