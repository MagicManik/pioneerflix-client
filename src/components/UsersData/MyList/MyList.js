...
const MyList = () => {
    ...
    return (
        ...
        <section className='bg-[#141414] lg:pt-16 pt-1'>
            <h1 className='px-2 md:px-16 lg:px-18 bg-black text-xl lg:text-2xl pt-5'>You have {myList.length} {myList.length > 1 ? 'videos' : 'video'} in your list. Thank you so much Dear, <span>{user?.displayName}</span></h1>
