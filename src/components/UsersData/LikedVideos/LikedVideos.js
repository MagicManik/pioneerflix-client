...
const LikedVideos = () => {
    ...
    return (
        <section className='bg-[#141414] lg:pt-16 pt-1'>
            <h1 className='px-2 md:px-16 lg:px-18 bg-black text-xl lg:text-2xl pt-5'>You liked total {likedUser?.length} {likedUser?.length > 1 ? 'videos' : 'video'}. Thank you so much Dear, <span className='text-[#ff9501]'>{user?.displayName}</span></h1>
