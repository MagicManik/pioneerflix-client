...
const SearchResults = () => {
    ...
    return (
        <section className='bg-[#141414] lg:pt-16 pt-0'>
            <h1 className='px-2 md:px-16 lg:px-18 text-red-600 bg-black text-xl lg:text-2xl lg:pt-5 pt-1'>Your Search Result For "{id}"</h1>
